...
OTF_init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    o->owned = 1;
    track_resource(&o->res_node, (void **)&o->otf,
                   (resource_free_fn)uiFreeOpenTypeFeatures);
    return 0;
}
...
OTF_clone(PyObject *self, PyObject *Py_UNUSED(args))
{
    ...
    clone->owned = 1;
    track_resource(&clone->res_node, (void **)&clone->otf,
                   (resource_free_fn)uiFreeOpenTypeFeatures);
...
wrap_attribute(uiAttribute *raw)
{
    ...
    a->attr = raw;
    a->owned = 1;
    track_resource(&a->res_node, (void **)&a->attr,
                   (resource_free_fn)uiFreeAttribute);
