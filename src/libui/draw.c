...
DrawCtx_text(PyObject *self, PyObject *args)
{
    ...
    /* We need to forward-reference the layout struct */
    typedef struct {
        PyObject_HEAD
        uiDrawTextLayout *layout;
        PyObject *string_ref;
    } UiDrawTextLayoutObject_t;
    UiDrawTextLayoutObject_t *tl = (UiDrawTextLayoutObject_t *)layout_obj;
